...
const translations = {
  id: {
    ...
    desc_tiktok: "TikTok Followers & Like. Dorong kontenmu masuk FYP.",
...
// --- Removed Custom Cursor Logic here ---

// 3. Scroll To Top & Active Nav Logic
...
window.addEventListener('scroll', () => {
  ...
  sections.forEach(section => {
    ...
    if (pageYOffset >= (sectionTop - 200)) { // Offset for header height
...
initParticles();
animateParticles();// --- Dictionary Bahasa ---
const translations = {
  id: {
    nav_services: "Layanan",
    nav_offer: "Hot Offer 🔥",
